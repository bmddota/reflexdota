...
function Physics:Unit(unit)
  ...
  Physics:CreateTimer(unit.PhysicsTimerName, {
    ...
    callback = function(reflex, args)
      ...
      if not unit.bSlide and unit.vAcceleration.x == 0 and unit.vAcceleration.y == 0 and newVelLength < unit.fVelocityClamp then
        ...
        if unit.bHibernate then
          ...
          if unit.PhysicsHibernateCallback ~= nil then
            pcall(unit.PhysicsHibernateCallback, unit)
          end
          return
        end
